...
export default function Home(){
 ...
 const resume=()=>{runtime.current?.audio.start();changeMode('playing');requestLock();};
  ...
  {!entered&&!demoOnly&&<><TitleScreen ui={ui}/><div className="title-footer"><span>v7.1 · CHORUS</span>{githubLink}</div></>}
