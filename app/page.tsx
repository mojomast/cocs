...
export default function Home(){
 ...
 const resume=()=>{runtime.current?.audio.start();changeMode('playing');requestLock();};
  ...
  const ui:UiBag={mode,changeMode,enterMenu,exitToTitle,entered,settings,setSettings,setupOpen,setSetupOpen,closeSetup,singleOpen,setSingleOpen,singleSub,setSingleSub,singleMission,setSingleMission,startSinglePlayer,startSpectate,quickStart,reward,surpriseMe,nextUnlock,matchSummary,accessibility,setAccessibility,
   ...
   player,awards,scoreboard,resultTitle,resultDescription,resume,nextArena,campaignNext,isSingle,single,selectHordeUpgrade:chooseHordeUpgrade,resumeSingleplayer,lastDemo,prefs,ONBOARDING_STEPS,helpSections:HELP_SECTIONS,onboarding,setOnboarding,finishOnboarding,modalRef,singleRef,settingsRef,onboardingRef,runtime,
  ...
  {!entered&&!demoOnly&&<><TitleScreen ui={ui}/><div className="title-footer"><span>v6.5 · MOMENTUM</span>{githubLink}</div></>}
