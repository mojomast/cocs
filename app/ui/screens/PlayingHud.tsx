 ...
 return <div className={`game-hud${hud.spectate&&hideHud?' hide-hud':''}${touchControls&&!hud.spectate?' touch-mode':''}`}>
  ...
  <div className="hud-bottom" role="region" aria-label="Player status">
   <div className="hud-corner hud-corner--left">
    <div className="stat-card stat-card--health"><span className="stat-label">HEALTH</span><strong className="stat-value">{Math.ceil(player.health)}</strong><span className="stat-bar"><i style={{width:`${healthRatio*100}%`}}/></span></div>
    <div className="stat-card stat-card--armor"><span className="stat-label">ARMOR</span><strong className="stat-value">{Math.ceil(player.armor)}</strong><span className="stat-bar"><i style={{width:`${armorRatio*100}%`}}/></span></div>
