...
import {Modal,Panel,Btn,Stats,Tabs,Chip} from '../primitives';
...
export function ResultsModal({ui}:ScreenProps){
 const {hud,awards,scoreboard,resultTitle,resultDescription,start,nextArena,playDemo,disconnectNet,changeMode,lastDemo,net,modalRef,player,mode}=ui;
