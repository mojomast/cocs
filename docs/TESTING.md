...
Last verified on release v4.16 (2026-09-16):

- `npm run test:game` — **1331 pass, 0 fail**, across 118 `game/*.test.mjs` files.
- `npm run test:server` — **146 pass, 0 fail**, across 16 `server/*.test.mjs` files.
