...
export const GAME_MODES = [
 {id:'deathmatch',name:'Deathmatch',description:'Everyone for themselves. Start with a Pulse Rifle, scavenge the rest, first to the frag limit wins.',rules:{team:false,score:'frags',fragLimit:15}},
   {id:'ctf',name:'Capture the Flag',description:'Steal the enemy flag and run it home while keeping your own safe. Classic, chaotic, worth it.',rules:{team:true,score:'captures',fragLimit:3,carrierSpeed:.9}},
  {id:'koth',name:'King of the Hill',description:'Take the central hill and hold it second by second. Contest it to freeze the enemy clock.',rules:{team:true,score:'hillTime',fragLimit:100,minFragLimit:1,maxFragLimit:900,vehicles:false,rotationSeconds:30,zoneBuff:'haste',objective:{kind:'koth',captureSeconds:5}}},
 ...
 {id:'teamdeathmatch',name:'Team Deathmatch',description:'Shared team score with friendly fire off. Win together or feed together.',rules:{team:true,score:'teamFrags',fragLimit:30}},
  ...
  {id:'combined-arms',name:'Combined Arms',description:'Command infantry, armour and aircraft across the largest battlefields. Hold the zones together.',rules:{team:true,score:'zoneTime',fragLimit:200,minFragLimit:50,maxFragLimit:900,vehicles:true,objective:{kind:'domination',captureSeconds:6},maxBots:16}},
...
export const DEFAULT_CONFIG = Object.freeze({mode:'deathmatch',botCount:2,difficulty:'easy',fragLimit:15,timeLimit:300,respawn:2,speed:1,gravity:1,damage:1,fastPowers:false,lifeSteal:false,unlimitedAmmo:false,suddenDeath:false,randomLoadout:false,oneShot:false,bounty:false,berserk:false,startingWeapon:0,playerName:'',mission:DEFAULT_MISSION_ID});
export const DEFAULT_DISPLAY = Object.freeze({fov:82,crosshair:'cross',color:'#c2ffea',size:1,showFps:false,showWeapon:true,resolutionScale:.5,bloom:0,exposure:1.15,postFx:false,teamPalette:'default',reducedMotion:false,invertY:false,adsSensitivity:.85,touchSensitivity:1,captions:false,showKillFeed:true,showDamageNumbers:true,showRadar:true});
