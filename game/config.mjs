...
export const DEFAULT_DISPLAY = Object.freeze({fov:82,crosshair:'cross',color:'#c2ffea',size:1,showFps:false,showWeapon:true,resolutionScale:.5,bloom:0,exposure:1.15,postFx:false,quality:'auto',effectsQuality:'auto',cameraShake:1,weaponBob:1,teamPalette:'default',reducedMotion:false,invertY:false,adsSensitivity:.85,touchSensitivity:1,captions:false,showKillFeed:true,showDamageNumbers:true,showRadar:true});
