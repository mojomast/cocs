...
import {createVehicle,GUNTRUCK,respawnVehicle,stepVehicle,stepVehicleWeapon,vehicleCanEnter,vehicleMuzzles,vehicleSeatFor,vehicleSeatPosition,vehicleMounted,takeVehicleSeat,leaveVehicleSeat,vehicleSeatOpen,vehicleWeakPointMultiplier,vehicleDismountStun,passengerFireScale} from './vehicles.mjs';
     ...
     for(let pellet=0;pellet<Math.max(1,spec.shots);pellet++){
      ...
      if(spec.kind==='projectile'){
       ...
       if(clear){
        ...
        else if(vehicleTarget)this.damageVehicle(vehicleTarget,spec.damage*affinityDamage*falloff,a,{from:a});
