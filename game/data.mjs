export const CHARACTERS = [
 ...
 {id:'mistral',name:'Mistral',stats:{health:100,armor:0,speed:9.2},color:'#ffbd59',accent:'#ffe1a1',tag:'THE LE COQ',detail:'Fiercely European, proudly open-weight, permanently mid-sentence in two languages.'},
...
export const HARNESSES = [
 ...
 {id:'claudecode',name:'Claude Code',power:'Guardrail',key:'04',icon:'shield',duration:3,cooldown:11,magnitude:.5,description:'Halves incoming damage while it asks “are you sure?” three times. The review always approves.',stat:'50% resistance · 3 seconds'},
