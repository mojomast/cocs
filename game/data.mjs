...
export const HARNESSES = [
 ...
 {id:'hermes',name:'Hermes',power:'Courier Rush',key:'02',icon:'rush',duration:3,cooldown:10,magnitude:1.6,description:'A courier surge of next-day-delivery speed. Your context window closes in three seconds. Run.',stat:'1.6× speed · 3 seconds'},
 ...
 {id:'claudecode',name:'Claude Code',power:'Guardrail',key:'04',icon:'shield',duration:3,cooldown:10,magnitude:.5,description:'Halves incoming damage while it asks “are you sure?” three times. The review always approves.',stat:'50% resistance · 3 seconds'},
 ...
 {id:'roo',name:'Roo Code',power:'Context Jam',key:'07',duration:3,cooldown:12,range:7,magnitude:.55,description:'Floods nearby enemies with irrelevant context until they slow down trying to read all of it.',stat:'7m radius · 45% slow'},
];
export const WEAPONS=[
  ...
  {name:'Grenade Launcher',short:'GRENADE',damage:30,splash:44,radius:3.5,speed:18,life:3,gravity:.65,bounce:.45,interval:.9,range:55,color:'#ff806b',ammo:6,cap:18,recoil:{kick:.045,recover:9,pattern:[[0,0],[.003,.005]]},bloom:{base:.004,perShot:.009,max:.05,recovery:.14,moveFactor:0},reload:2.5,feel:{arc:'high',impact:'heavy',kick:[.095,.075,10],shot:[210,.18,'sawtooth',45],launch:[130,.2,'sawtooth',32],impact:[72,.28,'sawtooth',25],tracer:[.18,.09],muzzle:[.21,.1],impactVisual:'burst'}},
