...
const megastructure={
  ...
  vehicles:[{id:'ironfall-puma-w',kind:'puma',x:-46,z:-6,yaw:Math.PI/2},{id:'ironfall-puma-e',kind:'puma',x:46,z:6,yaw:-Math.PI/2},{id:'ironfall-hornet-n',kind:'hornet',x:-22,y:7,z:-26,yaw:0},{id:'ironfall-hornet-s',kind:'hornet',x:22,y:7,z:26,yaw:Math.PI},{id:'ironfall-titan-w',kind:'titan',x:-40,z:-8,yaw:Math.PI/2},{id:'ironfall-titan-e',kind:'titan',x:40,z:8,yaw:-Math.PI/2},{id:'ironfall-scout-w',kind:'scout',x:-48,z:8,yaw:Math.PI/2},{id:'ironfall-scout-e',kind:'scout',x:48,z:-8,yaw:-Math.PI/2},{id:'ironfall-transport-w',kind:'transport',x:-40,z:8,yaw:Math.PI/2},{id:'ironfall-transport-e',kind:'transport',x:40,z:-8,yaw:-Math.PI/2}],
  objectiveZones:[point(-43,-8,0),point(0,0,0),point(43,8,0)],
  pickups:[['health',-47,-10],['health',47,10],['armor',-22,-23],['armor',22,23],['rocket',-22,23],['rocket',22,-23],['rail',0,-23],['rail',0,23],['scatter',-6.75,0],['scatter',6.75,0],['plasma',-3,0],['plasma',3,0],['grenade',-30,-23],['shock',30,23],['flak',0,-4],['haste',-40,8],['overcharge',40,-8],['overshield',0,0]],
...
const plateau={
  ...
  vehicles:[{id:'longreach-puma-w',kind:'puma',x:-45,z:-8,yaw:Math.PI/2},{id:'longreach-puma-e',kind:'puma',x:45,z:8,yaw:-Math.PI/2},{id:'longreach-hornet-n',kind:'hornet',x:-25,z:-30,yaw:0},{id:'longreach-hornet-s',kind:'hornet',x:25,z:30,yaw:Math.PI},{id:'longreach-titan-w',kind:'titan',x:-45,z:8,yaw:Math.PI/2},{id:'longreach-titan-e',kind:'titan',x:45,z:-8,yaw:-Math.PI/2},{id:'longreach-scout-w',kind:'scout',x:-52,z:12,yaw:Math.PI/2},{id:'longreach-scout-e',kind:'scout',x:52,z:-12,yaw:-Math.PI/2}],
  objectiveZones:[point(-52,-10,0),point(0,0,0),point(52,10,0)],
  pickups:[['health',-56,-12],['health',56,12],['armor',-25,-30],['armor',25,30],['rocket',-25,30],['rocket',25,-30],['rail',0,-34],['rail',0,34],['scatter',-10,0],['scatter',10,0],['plasma',-3,0],['plasma',3,0],['grenade',-35,-30],['shock',35,30],['flak',0,-4],['haste',-45,10],['overcharge',45,-10],['overshield',0,0]],
