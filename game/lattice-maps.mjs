...
const devices=[
 ...
 device('zip-s-w','zipline','south-flank',[-40,50],[-6,46],{speed:12}),
 device('zip-s-e','zipline','south-flank',[40,-50],[6,-46],{speed:12}),
 device('zip-s-w2','zipline','south-flank',[-88,50],[-60,46],{speed:12}),
 device('zip-s-e2','zipline','south-flank',[88,-50],[60,-46],{speed:12}),
