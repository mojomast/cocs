...
export const HELP_SECTIONS = Object.freeze([
  Object.freeze({
    ...
    items: Object.freeze([
      ...
      'TACTICAL MAP · Open MAP from the HUD (J by default). Inspect landmarks, elevation, objectives and revealed intel. Commanders can arm an order, select a legal objective and issue it from the map. Close the map to return to combat.',
      'PLAYER SQUADS · Open SQUADS (L by default) to create, join or leave a four-operator squad. Leaders can promote or remove members; commanders can manage allied squads. Team stance and routes apply to the whole team. Player squads are separate from AI reinforcement THREADS.',
