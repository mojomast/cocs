...
export const SHOWCASES=[
 ...
 {id:'deathmatch',label:'Deathmatch',mode:'deathmatch',maps:['colosseum','forge','substation','atrium','crosswire'],bots:7,difficulty:'normal',timeLimit:60,fragLimit:10,seatVehicles:0},
 {id:'teamdeathmatch',label:'Team Deathmatch',mode:'teamdeathmatch',maps:['warfront','titan-valley','atrium','riverbend','crosswire'],bots:8,difficulty:'normal',timeLimit:60,fragLimit:20,seatVehicles:0},
 {id:'ctf',label:'Capture the Flag',mode:'ctf',maps:['skybreak','frost-gate','launchpad','citadel','blood-gulch'],bots:8,difficulty:'normal',timeLimit:60,fragLimit:2,seatVehicles:0},
 {id:'koth',label:'King of the Hill',mode:'koth',maps:['colosseum','sunken-hill','skyfall-basin','forge'],bots:7,difficulty:'normal',timeLimit:60,fragLimit:60,seatVehicles:0},
 ...
 {id:'payload',label:'Payload',mode:'payload',maps:['frost-gate','derelict-station','convoy-line','launchpad','citadel'],bots:6,difficulty:'normal',timeLimit:60,fragLimit:2,seatVehicles:0},
];
